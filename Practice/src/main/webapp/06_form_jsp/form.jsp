...
<script src="https://spi.maps.daum.net/imap/map_js_init/postcode.v2.js"></script>
	...
	<h3>회원가입</h3>
	<form action= "form_process_1.jsp" name = "member" method="post">
	...
	-<input name="phone2" maxlength="4" size="4" type="text"></input>
	-<input name="phone3" maxlength="4" size="4" type="text"></input>
	...
	<p> <input type="submit" value ="가입쓰기">
